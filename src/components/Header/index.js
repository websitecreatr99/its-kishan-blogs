...
import { DribbbleIcon, GithubIcon, KaggleIcon, LinkedinIcon, MoonIcon, SunIcon, TwitterIcon } from "../Icons";
  ...
  return (
    <header className="w-full p-4  px-5 sm:px-10 flex items-center justify-between">
        ...
        <div className=" hidden sm:flex items-center">
            ...
            <a href={siteMetadata.kaggle} rel="noopener noreferrer" className="inline-block w-6 h-6 mr-4" aria-label="Check my profile on Dribbble" target="_blank"><KaggleIcon className="hover:scale-125 transition-all ease duration-200" /></a>
        </div>
    </header>
  )
}
